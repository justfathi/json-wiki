...
class WikiHandler(webapp2.RequestHandler):
    ...
    def initialize(self, *a, **kw):
		...
		#self.can_post = self.user and self.user.name == "fathi"
...
class MainPage(WikiHandler):
  def get(self):
      self.write('how to use jason wiki, hashed username and passwords, memchace!')
...
class Unit3Welcome(WikiHandler):
    def get(self):
        if self.user:
